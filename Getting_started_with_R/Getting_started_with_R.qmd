...
Note that you do not need to explicitly load the `rgdal` package since its functionality is used in the `raster` package.
...
The second parameter in the `rescale()` function, `1000`, tells R to divide the planar unit by 1000.
